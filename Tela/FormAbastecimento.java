...
public class FormAbastecimento extends javax.swing.JFrame {
    ...
    public static String arquivo = "abastecimentos.txt";

    public FormAbastecimento() throws ClassNotFoundException {
        initComponents();
        ...
        for (Object obj : lista) {
            Abastecimento cada = (Abastecimento) obj;
        ...
        for (Object obj : fornecedores) {
            ...
            if (cada.getTipo().equals("COMBUSTIVEL")) {
    ...
    private void initComponents() {
        ...
        litrosCampo = new javax.swing.JTextField();
        ...
        litrosCampo.setEditable(false);
        litrosCampo.setEnabled(false);
        litrosCampo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                litrosCampoActionPerformed(evt);
            }
        });

        jLabel16.setText("Odômetro");

        odometroCampo.setEditable(false);
        odometroCampo.setEnabled(false);
        odometroCampo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                odometroCampoActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(litrosCampo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(dataCampo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(valorCampo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(odometroCampo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(layout.createSequentialGroup()
                            .addGap(100, 100, 100)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel15)
                    .addComponent(litrosCampo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel3)
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        ...
        litrosCampo.setText(Double.toString(item.getLitros()));
        notasCampo.setText(item.getNotas());
        odometroCampo.setText(item.getOdometro());
    ...
    private void adicionarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarItemActionPerformed
        ...
        JTextField campos[] = {dataCampo, valorCampo, litrosCampo, odometroCampo};
    ...
    private void salvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarItemActionPerformed
        ...
        if (dataCampo.getText().isEmpty()
            ...
            item.setOdometro(odometroCampo.getText());
            item.setFornecedor(fornecedor);
            item.setValor(Double.parseDouble(valorCampo.getText()));
            item.setLitros(Double.parseDouble(litrosCampo.getText()));
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "abastecimento id " + item.getId() + " criado");
                quantidade.setText("QUANTIDADE: " + Integer.toString(lista.size()));
                jTable1.requestFocus();
                jTable1.changeSelection(0, 0, false, false);
    ...
    private void editarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarItemActionPerformed
        ...
        JTextField campos[] = {dataCampo, odometroCampo, valorCampo, litrosCampo};
        for (JTextField cada : campos) {
            cada.setEnabled(true);
        }
        notasCampo.setEnabled(true);
    ...
    private void recomecarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recomecarItemActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FormAbastecimento.class
    ...
    private void atualizarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atualizarItemActionPerformed
        ...
        try {
            Generico.salvaFicheiro(arquivo, lista);
            JOptionPane.showMessageDialog(null, "abastecimento id " + item.getId() + " editado");
            jTable1.requestFocus();
            jTable1.changeSelection(0, 0, false, false);
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, ex.getMessage());
    ...
    private void litrosCampoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_litrosCampoActionPerformed
        String litros = Double.toString(Generico.moeda("Quantidade litros"));
        litrosCampo.setText(litros);
    }//GEN-LAST:event_litrosCampoActionPerformed

    private void odometroCampoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_odometroCampoActionPerformed
        odometroCampo.setText(Generico.campoValidado("[0-9]+", "Odômetro retorno"));
    }//GEN-LAST:event_odometroCampoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAbastecimento.class
    ...
    private javax.swing.JTextField litrosCampo;
