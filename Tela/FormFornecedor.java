...
public class FormFornecedor extends javax.swing.JFrame {
    ...
    public FormFornecedor() throws ClassNotFoundException {
        initComponents();
        Generico.carregaLista("fornecedores.txt", lista);
        ...
        for (Object obj : lista) {
            ...
            Object item[] = {cada.getId(), cada.getNome(), cada.getTipo(),
                cada.getFone(), cada.getEmail(), cada.getContato(), cada.getNotas(),
                cada.getStatus()};
            tab.addRow(item);
        }
    ...
    private void initComponents() {
        ...
        contatoCampo = new javax.swing.JTextField();
        ...
        contatoCampo.setEditable(false);
        contatoCampo.setToolTipText("Letra, número");
        contatoCampo.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        contatoCampo.setEnabled(false);
        contatoCampo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                contatoCampoActionPerformed(evt);
            }
        });

        tipoBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "COMBUSTIVEL", "PEÇAS", "SERVIÇOS", "PEÇAS E SERVIÇOS", "SEGURO" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOME", "TIPO", "TELEFONE", "EMAIL", "CONTATO", "NOTAS", "STATUS"
            }
        ) {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(contatoCampo, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(tipoBox, javax.swing.GroupLayout.PREFERRED_SIZE, 292, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel3)
                            .addComponent(contatoCampo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        ...
        idCampo.setText(Integer.toString(fornecedor.getId()));
        nomeCampo.setText(fornecedor.getNome());
        emailCampo.setText(fornecedor.getEmail());
        telefoneCampo.setText(fornecedor.getFone());
        notasCampo.setText(fornecedor.getNotas());
        contatoCampo.setText(fornecedor.getContato());
        statusBox.setSelectedItem(fornecedor.getStatus());
        tipoBox.setSelectedItem(fornecedor.getTipo());
    ...
    private void adicionarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarItemActionPerformed
        JTextField camposTexto[] = {nomeCampo, contatoCampo,
            telefoneCampo, emailCampo};
        this.setTitle("NOVO FORNECEDOR");
    ...
    private void salvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarItemActionPerformed
        if (nomeCampo.getText().isEmpty()) {
            ...
            item.setContato(Generico.campoFormatado(contatoCampo));
            item.setTipo((String) tipoBox.getSelectedItem());
            item.setStatus((String) statusBox.getSelectedItem());
            item.setFone(telefoneCampo.getText());
            item.setEmail(emailCampo.getText().toLowerCase());
            ...
            if (lista.contains(item)) {
                ...
                lista.add(item);
                Object obj[] = {item.getId(), item.getNome(), item.getTipo(),
                    item.getFone(), item.getEmail(), item.getContato(), item.getNotas(),
                    item.getStatus()};
                tab.addRow(obj);
                try {
                    Generico.salvaFicheiro("fornecedores.txt", lista);
    ...
    private void atualizarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atualizarItemActionPerformed
        ...
        if (liberado == 1) {
            fornecedor.setNome(Generico.campoFormatado(nomeCampo));
            fornecedor.setTipo((String) tipoBox.getSelectedItem());
            fornecedor.setFone(telefoneCampo.getText());
            fornecedor.setEmail(emailCampo.getText().toLowerCase());
            fornecedor.setNotas(notasCampo.getText().replaceAll("\\s+", " ").trim());
            fornecedor.setContato(Generico.campoFormatado(contatoCampo));
            fornecedor.setStatus((String) statusBox.getSelectedItem());
            try {
                Generico.salvaFicheiro("fornecedores.txt", lista);
                JOptionPane.showMessageDialog(null, fornecedor.getNome() + " editado");
                jTable1.requestFocus();
                jTable1.changeSelection(0, 0, false, false);
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(null, ex.getMessage());
            }
            jTable1.setValueAt(fornecedor.getId(), linhaAtual, 0);
            jTable1.setValueAt(fornecedor.getNome(), linhaAtual, 1);
            jTable1.setValueAt(fornecedor.getTipo(), linhaAtual, 2);
            jTable1.setValueAt(fornecedor.getFone(), linhaAtual, 3);
            jTable1.setValueAt(fornecedor.getEmail(), linhaAtual, 4);
            jTable1.setValueAt(fornecedor.getContato(), linhaAtual, 5);
            jTable1.setValueAt(fornecedor.getNotas(), linhaAtual, 6);
            jTable1.setValueAt(fornecedor.getStatus(), linhaAtual, 7);
        }
    ...
    private void contatoCampoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_contatoCampoActionPerformed
        contatoCampo.setText(Generico.campoValidado(Generico.regexLetra, "Pessoa de contato"));
    }//GEN-LAST:event_contatoCampoActionPerformed
    ...
    private javax.swing.JTextField contatoCampo;
