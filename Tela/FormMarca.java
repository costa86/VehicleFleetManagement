...
public class FormMarca extends javax.swing.JFrame {
    ...
    public static String arquivo = "marcas.txt";

    public FormMarca() throws ClassNotFoundException {
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(nomeCampo, javax.swing.GroupLayout.DEFAULT_SIZE, 341, Short.MAX_VALUE)
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        ...
        idCampo.setText(Integer.toString(marca.getId()));
        nomeCampo.setText(marca.getNome());
    ...
    private void salvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarItemActionPerformed
        if (nomeCampo.getText().isEmpty()) {
            ...
            Marca item = new Marca(max + 1, Generico.campoFormatado(nomeCampo), fabricante);
    ...
    private void atualizarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atualizarItemActionPerformed
        ...
        if (liberado == 1) {
            marca.setNome(Generico.campoFormatado(nomeCampo));
            marca.setFabricante(fabricante);
            try {
                Generico.salvaFicheiro(arquivo, lista);
                JOptionPane.showMessageDialog(null, marca.getNome() + " editado");
                jTable1.requestFocus();
                jTable1.changeSelection(0, 0, false, false);
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(null, ex.getMessage());
            }
            jTable1.setValueAt(marca.getId(), linhaAtual, 0);
            jTable1.setValueAt(marca.getNome(), linhaAtual, 1);
            jTable1.setValueAt(marca.getFabricante().getNome(), linhaAtual, 2);
        }
